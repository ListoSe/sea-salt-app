export const FULL_DECK = [
  ...
  { id: 37, name: 'shark', type: 'pair', color: 'blue' },
  { id: 38, name: 'crab', type: 'pair', color: 'black' },
  { id: 39, name: 'fish', type: 'pair', color: 'green' },
  { id: 40, name: 'shell', type: 'collector', color: 'black' },
  { id: 41, name: 'mermaid', type: 'mermaid', color: 'mermaid' },
  { id: 42, name: 'fish', type: 'pair', color: 'yellow' },
  { id: 43, name: 'crab', type: 'pair', color: 'lightblue' },
  { id: 44, name: 'penguin', type: 'collector', color: 'pink' },
  { id: 45, name: 'boat', type: 'pair', color: 'yellow' },
  { id: 46, name: 'lighthouse', type: 'multiplier', color: 'purple' },
  { id: 47, name: 'crab', type: 'pair', color: 'yellow' },
  { id: 48, name: 'crab', type: 'pair', color: 'green' },
  { id: 49, name: 'penguin', type: 'collector', color: 'purple' },
  { id: 50, name: 'swimmer', type: 'pair', color: 'black' },
  { id: 51, name: 'mermaid', type: 'mermaid', color: 'mermaid' },
  { id: 52, name: 'shell', type: 'collector', color: 'gray' },
  { id: 53, name: 'octopus', type: 'collector', color: 'yellow' },
  { id: 54, name: 'shark', type: 'pair', color: 'lightblue' },
  { id: 55, name: 'octopus', type: 'collector', color: 'lightblue' },
  { id: 56, name: 'capitan', type: 'multiplier', color: 'lightorange' },
  { id: 57, name: 'swimmer', type: 'pair', color: 'lightblue' },
  { id: 58, name: 'mermaid', type: 'mermaid', color: 'mermaid' },
];